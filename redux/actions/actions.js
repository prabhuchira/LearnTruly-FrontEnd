...
export const GET_CLASSES_FUNC = () => {
    ...
    return async dispatch => {
       let token = await AsyncStorage.getItem('loginToken');
        await Axios.get('http://192.168.0.105:3000/getClasses',{headers:{
            "Auth-Token":token
        }}).then(
          (data)=>dispatch({
              type:GET_CLASSES,
...
export const GET_STUDENTS_FUNC = (className,selectBranch) => {
    ...
    return async dispatch => {
       let token = await AsyncStorage.getItem('loginToken');
        await Axios.get('http://192.168.0.105:3000/getStudents',{headers:{
            "Auth-Token":token,
            "className":className,
            "branch":selectBranch
        }
...
export const ACTIVATE_USER = (item,index) => {
    ...
    return async dispatch => {
        let token = await AsyncStorage.getItem('loginToken');
        await Axios.post('http://192.168.0.105:3000/activateStudent',{
...
export const GET_ALL_REQUESTS_FUNC = () => {
    ...
    return async dispatch => {
       let token = await AsyncStorage.getItem('loginToken');
        await Axios.get('http://192.168.0.105:3000/getAllRequests',{headers:{
            "Auth-Token":token
...
export const APPROVE_REQUEST_FUNC = (item,index) => {
    ...
    return async dispatch => {
       let token = await AsyncStorage.getItem('loginToken');
        await Axios.post('http://192.168.0.105:3000/approveRequest',{
            activate_id:item._id
        },{headers:{
            "Auth-Token":token
...
export const PUSH_EVENT_FUNC = (body) => {
    return async dispatch => {
        let token = await AsyncStorage.getItem('loginToken');
        await Axios.post('http://192.168.0.105:3000/createEvent',{
            ...body
...
export const MODIFY_EVENT_FUNC = (body) => {
    return async dispatch => {
        let token = await AsyncStorage.getItem('loginToken');
        await Axios.post('http://192.168.0.105:3000/modifyEvent',{
            ...body
        },{headers:{"Auth-Token":token}}).then(
            (data)=>
            dispatch({
...
export const DELETE_EVENT_FUNC = (body) => {
    return async dispatch=>{
        let token = await AsyncStorage.getItem('loginToken');
        await Axios.post('http://192.168.0.105:3000/deleteEvent',{
            ...body
...
export const GET_EVENTS_FUNC = () => {
    ...
    return async dispatch => {
       let token = await AsyncStorage.getItem('loginToken');
        await Axios.get('http://192.168.0.105:3000/getEvents',{headers:{
            "Auth-Token":token
        }}).then(
          (data)=>dispatch({
              type:"GET_EVENTS",
...
export const GET_EVENTS_STUDENTS_FUNC = () => {
    ...
    return async dispatch => {
       let token = await AsyncStorage.getItem('loginToken');
        await Axios.get('http://192.168.0.105:3000/studentGetEvents',{headers:{
            "Auth-Token":token
        }}).then(
          (data)=>dispatch({
              type:"GET_EVENTS",
